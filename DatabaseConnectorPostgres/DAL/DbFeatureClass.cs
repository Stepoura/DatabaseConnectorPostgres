    ...
    public class DbFeatureClass
    {
        ...
        public async Task InsertFeature(DbFeature feature)
        {
            ...
            if (flag)
            {
                ...
                await using (var writer = await cmd.ExecuteReaderAsync())
                    try
                    {
        ...
        public async Task InsertFeatures(List<DbFeature> features)
        {
